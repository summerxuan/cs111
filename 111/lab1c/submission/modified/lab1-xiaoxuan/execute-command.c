...
void 
add_command_to_run(command_t new_command_t );
int
...
command_stream_t command_run_tail;
command_stream_t command_run_head;
command_stream_t init_command_run(command_t new_command_t)
{
...
add_command_to_run(command_t new_command_t )
{
  ...
  if(command_run_tail == NULL)
  {
    command_run_tail = init_command_run(new_command_t);
    command_run_head = command_run_tail;
  }
  else
  {
    command_stream_t command_stream_new = init_command_run(new_command_t);
    //command_stream_head->next = command_stream_new;
    command_run_tail->next = command_stream_new;
    command_stream_new->prev = command_run_tail;
    command_run_tail = command_stream_new;
    command_run_tail->next = NULL;
