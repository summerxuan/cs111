      ...
      while (  !is_empty(operators) && top(operators)->type == PIPE_COMMAND )
       ...
       if(strcmp(token_now->text,"!")== 0)
       {
          ...
          else if(token_now->t_type == WORD &&strcmp(token_now->text, "if")==0)
        {
          ...
          if (token_now->t_type == WORD &&(strcmp (token_now->text, "else") ==0 || strcmp (token_now->text, "fi") ==0))
            {
              error(2, 0, "Line %d: Syntax error. incorrect token \"else\" or  \"fi\". ", line);
              return NULL;
            }
            ...
            if (strcmp ( token_now->text, "else") == 0)
            {
             ...
             if (strcmp (token_now->text, "elif") ==0 || strcmp (token_now->text, "fi") ==0)
              {
                error(2, 0, "Line %d: Syntax error. incorrect token \"elif\" or  \"fi\". ", line);
                return NULL;
              }
