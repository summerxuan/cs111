    ...
    
    {
      ...
      while (  !is_empty(operators) && top(operators)->type == PIPE_COMMAND )
        ...
        if (strcmp (token_now->text, "until") == 0 ||strcmp (token_now->text, "while") == 0 ||strcmp (token_now->text, "for") == 0)
          {
            ...
            int count_do = 0;
            if (strcmp (token_now ->text, "do") ==0 )
            {
              error(2, 0, "Line %d: Syntax error. incorrect token \"do\". ", line);
              return NULL;
            }
            while (strcmp ( token_now->text, "do") != 0)
            {
              if (strcmp ( token_now->text, "then") == 0 || strcmp ( token_now->text, "if") == 0 || strcmp ( token_now->text, "done") == 0 || strcmp ( token_now->text, "\n") == 0 || strcmp ( token_now->text, ";") == 0)
              {
                error(2, 0, "Line %d: Syntax error. incorrect token \"do\".", line);
                return NULL;
              }
          ...
          else if(strcmp(token_now->text, "if")==0)
        {
          ...
          while (strcmp ( token_now->text, "else") != 0 && strcmp ( token_now->text, "fi") != 0 )
            {
              if (token_now->t_type == HEAD)
              {
                error(2, 0, "Line %d: Syntax error. missing token \"else\" or  \"fi\".", line);
                return NULL;
              }
            ...
            if (strcmp ( token_now->text, "else") == 0)
            {
             ...
             while (strcmp ( token_now->text, "fi") != 0 )
             {
               if (token_now->t_type == HEAD)
                {
                  error(2, 0, "Line %d: Syntax error. missing token  \"fi\".", line);
                  return NULL;
                }
