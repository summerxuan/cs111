        ...
        if (strcmp (token_now->text, "until") == 0 ||strcmp (token_now->text, "while") == 0 ||strcmp (token_now->text, "for") == 0)
          {
            ...
            {
              if (token_now->t_type == WORD &&strcmp ( token_now->text, "then") == 0 || strcmp ( token_now->text, "if") == 0 || strcmp ( token_now->text, "done") == 0 || strcmp ( token_now->text, "\n") == 0 || strcmp ( token_now->text, ";") == 0)
              {
                error(2, 0, "Line %d: Syntax error. incorrect token \"do\".", line);
                return NULL;
              }
          ...
          //if command
          else if(strcmp(token_now->text, "if")==0)
        {
          ...
          int count_if = 0;
          if(strcmp(token_now->text,"then") ==0)//if is directly followed by if
          {
            error(2, 0, "Line %d: Syntax error. ONLY words and SUBSHELL can follow redirection", line);
            return NULL;
          }
          while(strcmp(token_now->text,"then")!=0)
          {
            if (strcmp ( token_now->text, "do") == 0 || strcmp ( token_now->text, "if") == 0 || strcmp ( token_now->text, "done") == 0 || strcmp ( token_now->text, "\n") == 0 || strcmp ( token_now->text, ";") == 0)
              {
                error(2, 0, "Line %d: Syntax error. incorrect token \"do\".", line);
                return NULL;
              }
          ...
          if (strcmp (token_now->text, "else") ==0 || strcmp (token_now->text, "fi") ==0)
            {
